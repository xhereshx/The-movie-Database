...
class PopularTvSeries extends React.Component {
  ...
  handleSubmit = () => {
    fetch(
      `https://api.themoviedb.org/3/tv/popular?api_key=054382f1b063f38f88579fee1be9f3c9&language=en-US&page=1`
    )
    ...
    return (
      <>
        <div>
          ...
          {this.state.currentMovieTwo == null ? (
            <div>
            ...
            <MovieInfo
              ...
              currentMovie={this.state.currentMovieTwo}
            />
          )}
        </div>
